...
Подготовлены пакет, адаптеры, миграторы и конфигурация кандидата; на VPS прошли 209 регрессий.
Запущены контейнер standby без сети и изолированная панель с TLS/mTLS и авторизацией.
